        ...
        <section className="flex-grow flex items-center justify-center px-4 md:px-6 py-12 relative z-10">
          ...
          >
            <div className="flex flex-col items-center mb-8">
              ...
              <motion.p className="text-gray-300 text-center" variants={itemVariants}>
            ...
            <motion.form onSubmit={handleSubmit} className="space-y-6" variants={itemVariants}>
              ...
              {/* Submit */}
              <motion.button
                whileHover={{ scale: 1.02, boxShadow: "0 0 30px rgba(0, 255, 127, 0.8)", y: -2 }}
                whileTap={{ scale: 0.98 }}
                type="submit"
                disabled={loading}
                className={cn(
            ...
            {/* Login Link */}
            <motion.div variants={itemVariants} className="mt-8 text-center text-sm space-y-2">
